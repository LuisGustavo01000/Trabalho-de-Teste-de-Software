...
namespace BlackBelt.Controllers
{
    public class AlunosController : Controller
    {
        ...
        {
            var alunos = _alunoRepository.BuscarTodosAlunos();
            alunos = AplicarFiltros(alunos, filtroNome, filtroTurma);
        ...
        // Método extraído — responsável apenas pelos filtros de busca
        private IEnumerable<Aluno> AplicarFiltros(IEnumerable<Aluno> alunos, string filtroNome, string filtroTurma)
        {
